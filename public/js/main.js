...
jQuery(function ($) {
	...
	var display = $('#load-more-1').data('display');
	var button  = $('#load-more-button-1');
	var item    = $('.load-more-item-1').hide();
	...
	button.on('click', function(e) {
		...
		var item_hidden  = $('.load-more-item-1:hidden');
		var item_columns = $('#load-more-1').data('columns');
...
jQuery(function ($) {
	...
	var display = $('#load-more-2').data('display');
	var button  = $('#load-more-button-2');
	var item    = $('.load-more-item-2').hide();
	...
	button.on('click', function(e) {
		...
		var item_hidden  = $('.load-more-item-2:hidden');
		var item_columns = $('#load-more-2').data('columns');
...
jQuery(function ($) {
	...
	var display = $('#load-more-3').data('display');
	var button  = $('#load-more-button-3');
	var item    = $('.load-more-item-3').hide();
	...
	button.on('click', function(e) {
		...
		var item_hidden  = $('.load-more-item-3:hidden');
		var item_columns = $('#load-more-3').data('columns');
...
// #podcast
  ...
  $(document).ready(function () {
      // Hover play functionality for all videos with the 'hover-video' class
