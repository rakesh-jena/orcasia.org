...
(function () {
    ...
    $('#dm_article_delete_modal').on('show.bs.modal', function(e) {
        var url = $(e.relatedTarget).data('url');
        $(e.currentTarget).find('#dm_article_delete_form').attr("action", url);
    });
    $('#author_dm_article_delete_modal').on('show.bs.modal', function(e) {
        var url = $(e.relatedTarget).data('url');

        $(e.currentTarget).find('#author_dm_article_delete_form').attr("action", url);
    });
})();