...
use App\Http\Controllers\DMArticleController;
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::resource('yn-admin/episodesofexchanges', DMArticleController::class);
    ...
    Route::put('yn-admin/change-password', [AuthController::class, 'change_password']);
});
...
Route::get('/episodesofexchanges/{id}/{slug}', [DMArticleController::class, 'show']);
Route::get('/episodesofexchanges', [DMArticleController::class, 'list']);
 ...
 * ORCA frontend URLs
 * 
 * Route::get('/episodesofexchanges', [ArticleListingController::class, 'index']);
 * ------------------------------------------------------------------------
 * */
...
Route::get('/pages/consultancy', function () {
...
//Route::get('registration/truncate', [RegisterationController::class, 'truncateRows']);
