...
@section('content')
    ...
    <section class="shock-section has-holder pt-4 pb-8">
        <div class="container max-w-85">
            ...
            <div class="basic-intro text-center mb-5">
                ...
                <p class="description">To view all pictures of GCNS 2023, <a
                        href="https://orcasia.org/pages/gcns#lgx-media" target="_blank" style="color:red;">click
                        here.</a></p>
            </div>
            <!-- Banner -->
            <section class="shock-section mt-2 bg-image bg-fixed"
                data-bg-image="{{ URL::asset('images/gcnsorca.jpg') }}">
    ...
    <section class="shock-section has-overlay mt-2 bg-image bg-fixed"
        data-bg-image="{{ URL::asset('images/event.jpeg') }}">
        <div class="banner vh-65 align-h-center align-v-center">
            <div class="holder">
                <div class="gallery">
                            ...
                            <div class="card-body align-v-bottom">
                                <div class="holder">
                                    ...
                                    <h1 class="title white"><span
                                        ...
                                        <span
                                            class="text-2 text-style-10"><?= date_format(date_create($article->created_at), 'F Y') ?>
                                        </span>
