                        ...
                        <?php $category = App\Models\Category::where('id', $article->category)->first();?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endif
                                    <a href="{{ url('yn-admin/episodesofexchanges') }}/{{ $article->id }}/edit"
                                        class="btn btn-primary rounded-pill btn-sm">Edit</a>
                                    <button data-bs-toggle="modal" data-url="{{ url('yn-admin/episodesofexchanges/'.$article['id']) }}"
                                        data-bs-target="#dm_article_delete_modal" class="btn btn-danger rounded-pill btn-sm">Delete</button>
                                </td>
                            </tr>
                        <?php $count++;?>
                        @endforeach
...
<!-- End #main -->
<!-- Modals -->
@include('admin.episodesofexchanges.delete')
@endsection