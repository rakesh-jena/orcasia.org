<div class="modal fade" id="cypEvent_delete_modal" tabindex="-1" role="dialog"
    aria-labelledby="delete_modalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="delete_modalTitle">Delete CYP Event</h5>
            ...
            <div class="modal-footer">
                <form class="forms-sample" action="" id="cypEvent_delete_form" method="POST">
                    @csrf
                    @method('DELETE')             
