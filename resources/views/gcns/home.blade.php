                            ...
                            <div class="lgx-banner-info-area">
                                 ...
                                 <!-- <div class="lgx-banner-info-circle">
                                     <!-- <div class="info-circle-inner">
                                      <!--   <h3 class="date"><b class="lgx-counter">26</b> <span>September</span>
                                       <!--  </h3>
                                       <!--  <div class="lgx-countdown-area">
                                            <!-- Date Format :"Y/m/d" || For Example: 1017/10/5  -->
                                         <!--    <div id="lgx-countdown" data-date="2024/09/26"></div>
                                        </div>
                                    </div>
                                </div>
                            -->
                                <div class="lgx-banner-info">
                                    ...
                                    <div class="lgx-cart-area lgx-mg-btm">
                                        <a class="lgx-btn lgx-btn-font lgx-btn-red" target="_blank" href="https://orcasia.org/allfiles/ORCA's_GCNS_2024_Report.pdf">Download ORCA's GCNS 2024 Conference Report</a>
                                    </div>
                                    ...
                                    <a href="https://www.thegrandnewdelhi.com/" target="_blank"><h3 class="location"><i class="fa fa-map-marker"></i> The Grand, New Delhi<br></a>
                                        <i class="fa fa-calendar"></i> 26 - 27 SEPTEMBER 2024
                                    </h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="lgx-about-content-area">
                            ...
                            <div class="lgx-about-content textjustify">
                                ...
                                <div class="about-date-area">
                                    <h4 class="date"><span>26-27</span></h4>
                                    <p><span>September 2024</span> The Grand, New Delhi</p>
                                </div>
                                <div class="section-btn-area">
                                  ...
                                  <a class="lgx-btn lgx-btn-red" target="_blank" href="https://orcasia.org/allfiles/2024_GCNS_Handbook.pdf"><span>Download Handbook</span></a>
        ...
        <div class="lgx-inner">
            <div class="container">
                ...
                <div class="section-btn-area schedule-btn-area">
                    <a class="lgx-btn lgx-btn-big" href="https://orcasia.org/allfiles/ORCA_GCNS_2024_Schedule.pdf" target="_blank"><span>Download Schedule (PDF)</span></a>
                    <a class="lgx-btn lgx-btn-red lgx-btn-big" href="https://twitter.com/GCNS_ORCA"><span>Connect via Twitter</span></a>
                </div>
            </div>
            <!-- //.CONTAINER -->
        </div>
...
<!--SPEAKERS-->
<section>
<?php $speakerData = App\Models\Event\Speaker::where('id', '>=', 69)->orderBy('id', 'asc')->get(); ?>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="lgx-heading lgx-heading-white">
                            ...
                            <h3 class="subheading">Our speakers for ORCA's Global Conference on New Sinology 2024</h3>
                        </div>
                    </div>
                </div>
                <!--//.ROW-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="lgx-heading">
                            <h2 class="heading">Media</h2>
                            <h3 class="subheading">View the work of ORCA's GCNS 2024 Media below. </h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="sk-ww-flickr-album-single" data-embed-id="25523799"></div>
                    <script src="https://gcns2023.orcasia.org/js/widget.js" async="" defer=""></script>                    
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="lgx-heading">
                            ...
                            <h3 class="subheading">View the work of ORCA's GCNS 2024 Partners below. </h3>
                        </div>
                    </div>
                </div>
                <div class="row">
