              ...
              <div class="col-12 mt-3 col-lg-6 align-v-center">
                ...
                <div class="basic-intro text-center">
                  <h1 class="title black">
                    ...
                    <span class="text-2 text-style-4 text-italic"><mark class="animated-underline accentred">Guidelines</mark></span>
                  </h1>
                </div>
              </div>   
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card double-edge has-icon parent">
                <div class="card-body">
                  ...
                  <h3 class="title text-style-8 black">Submission Guidelines for<br><strong>Opinion Pieces</strong></h3>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card double-edge has-icon parent">
                <div class="card-body">
                  ...
                  <h3 class="title text-style-8 black">Submission Guidelines for<br><strong>Issue Briefs</strong> </h3>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card double-edge has-icon parent">
                <div class="card-body">
                  ...
                  <h3 class="title text-style-8 black">Submission Guidelines for<br><strong>Visualisations</strong></h3>
