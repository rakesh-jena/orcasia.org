                      ...
                      <div class="vertical-tab scheme-1 primary">
                          ...
                          <ul id="example-v-tab" class="nav nav-pills" role="tablist" aria-orientation="vertical">
                              <li class="nav-item" role="presentation">
                                  <button id="example-v-1-tab" class="nav-link active" aria-selected="true"
                                      aria-controls="example-v-1" data-bs-target="#example-v-1" data-bs-toggle="tab"
                                      role="tab">
                                      Daily Newsletter – Conversations in Chinese Media
                                  </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                  <button id="example-v-2-tab" class="nav-link" aria-selected="false"
                                      aria-controls="example-v-2" data-bs-target="#example-v-2" data-bs-toggle="tab"
                                      role="tab">
                                      Opinion Pieces
                                  </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                  <button id="example-v-11-tab" class="nav-link" aria-selected="false"
                                      aria-controls="example-v-11" data-bs-target="#example-v-11" data-bs-toggle="tab"
                                      role="tab">
                                      Dashboards
                                  </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                  <button id="example-v-3-tab" class="nav-link" aria-selected="false"
                                      aria-controls="example-v-3" data-bs-target="#example-v-3" data-bs-toggle="tab"
                                      role="tab">
                                      Expert Speak
                                  </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                  <button id="example-v-7-tab" class="nav-link" aria-selected="false"
                                      aria-controls="example-v-7" data-bs-target="#example-v-7" data-bs-toggle="tab"
                                      role="tab">
                                      ORCA Files
                                  </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                  <button id="example-v-6-tab" class="nav-link" aria-selected="false"
                                      aria-controls="example-v-6" data-bs-target="#example-v-6" data-bs-toggle="tab"
                                      role="tab">
                                      Backgrounders
                                  </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                  <button id="example-v-8-tab" class="nav-link" aria-selected="false"
                                      aria-controls="example-v-8" data-bs-target="#example-v-8" data-bs-toggle="tab"
                                      role="tab">
                              ...
                              <li class="nav-item" role="presentation">
                                  <button id="example-v-4-tab" class="nav-link" aria-selected="false"
                                      aria-controls="example-v-4" data-bs-target="#example-v-4" data-bs-toggle="tab"
                                      role="tab">
                                      Issue Brief
                                  </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                  <button id="example-v-9-tab" class="nav-link" aria-selected="false"
                                      aria-controls="example-v-9" data-bs-target="#example-v-9" data-bs-toggle="tab"
                                      role="tab">
                                      CiCM Insights
                                  </button>
                              </li>
                              ...
                              <li class="nav-item" role="presentation">
                                  <button id="example-v-5-tab" class="nav-link" aria-selected="false"
                                      aria-controls="example-v-5" data-bs-target="#example-v-5" data-bs-toggle="tab"
                                      role="tab">
                                    ...
                                    <div class="image-wrapper" data-lax="inertia-top">
                                      <img style="border-radius: 0.375rem;"
                                        src="assets/images/output/CICM-logo-for-home-page-and-about.png" class="image" alt="Image name" />
                                                                      ...
                                                                      <div class="col-12">
                                                                          <p>This output is based on our daily newsletter,
                                                                              Conversations in Chinese Media
                                                                              (CiCM). Fact-based short reports that take a
                                                                              deep dive into certain aspects covered
                                                                              in the CiCMs, these Insights allow interns
                                                                              working with us to delve more acutely
                                                                              into certain facets from their newsletter
                                                                              coverage and connect dots across multiple
                                                                              sources reporting on the same event to deduce
                                                                              its impact. Insights are not exactly
                                                                              analytical in nature; they are critical
                                                                              assessments of particular events that allow
                                                                              readers to at a glance understand the how,
                                                                              what, when, where and why of topics.
                                                                              These publications are limited to submissions
                                                                              by in-house interns only.</p>
                                                                      </div>
                                                                  </div>
                                                              </div>
                                                          </div>
