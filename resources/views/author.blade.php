    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="articles-nav"
                    class="nav-content collapse <?= str_contains(url()->current(), '/yn-author/articles') ? 'show' : '' ?>"
                    data-bs-parent="#sidebar-nav" style="">
                    <li>
                        <a href="{{ url('yn-author/articles') }}"
                            class="<?= request()->is('yn-author/articles') ? 'active' : '' ?>">
                            <i class="bi bi-circle"></i><span>All</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('yn-author/articles/create') }}"
                            class="<?= request()->is('yn-author/articles/create') ? 'active' : '' ?>">
