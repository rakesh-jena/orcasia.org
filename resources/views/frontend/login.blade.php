...
<section class="shock-section has-holder pt-6 pb-6">
    <div class="container max-w-50">
        ...
        <div class="form-area mb-35 scheme-1 primary">
            <form action="{{ url('user_login') }}" method="POST" enctype="multipart/form-data" class="form-fields needs-validation" novalidate>
                @csrf
                <div class="form-row row">
                <div class="form-col col-12 col-md-12">
                    <label for="InputBasicExampleEmail" class="form-label">Email</label>
                    <input type="email" name="email" class="form-control rounded-3" id="InputBasicExampleEmail" required="required">
                    <div class="invalid-feedback">Please enter a valid email address.</div>
                    <div class="valid-feedback">Looks good.</div>
                </div>
                <div class="form-col col-12 col-md-12">
                    <label for="InputBasicExampleName" class="form-label">Password</label>
                    <input type="password" name="password" class="form-control rounded-3 rounded-3" id="InputBasicExampleName" required="required">
