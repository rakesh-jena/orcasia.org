@extends('web')
@section('title', 'Register | NAAIS')
@section('meta_keywords', 'NAAIS')
          ...
          <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="card mb-3">
              ...
              <div class="card-body">
                ...
                <form class="row g-3 needs-validation" method="POST" enctype="multipart/form-data" action="{{ url('user_register') }}" novalidate>
                  @csrf
                  <div class="col-12">
