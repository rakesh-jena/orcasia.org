                ...
                <div class="col-12 col-md-6 align-h-center align-v-center">
                    ...
                    <div class="side-intro">
                        ...
                        <div class="description gray">
                            ...
                            <p>
                            <p class="white"><a href="https://orcasia.org/allfiles/GCNS_2023_Report.pdf" target="_blank"
                                    style="color:#e74646">Read ORCA's GCNS 2023 Conference Report</a></p>
            ...
            <div class="content-wrapper text-center">
                ...
                <div class="basic-intro mb-35">
                    ...
                    <div class="description maxwd white-50">
                        <p>We are a New-Delhi based research institute focusing on domestic Chinese politics/policy!<br>Our
            ...
            <div class="holder p-25 climb shadow rounded bg-color white">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4">
                        ...
                        <div class="animated-counter">
                            <div class="item text-center">
                                <div class="counter text-style-5" data-value="140" data-symbol="+" data-duration="2500"
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        ...
                        <div class="animated-counter">
                            <div class="item text-center">
                                <div class="counter text-style-5" data-value="550" data-symbol="+" data-duration="2500"
                                    data-text-bg-color="transparent" data-text-color="var(--primary-color)"></div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        ...
                        <div class="animated-counter">
                            <div class="item text-center">
                                <div class="counter text-style-5" data-value="182" data-symbol="" data-duration="2500"
                                    data-text-bg-color="transparent" data-text-color="var(--primary-color)"></div>
