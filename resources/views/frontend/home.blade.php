...
@section('meta_keywords', 'ORCA, Organisation for Research on China and Asia, China, research on china, orca india, orcasia, #china')
@section('meta_description', 'With assessments based on real-time, ground level chatter in/on/from #China, ORCA seeks to add new levels of research insight to how China perceives the world.')
...
@section('content')
    ...
    <meta name="twitter:description" content="With assessments based on real-time, ground level chatter in/on/from #China, ORCA seeks to add new levels of research insight to how China perceives the world.">
                ...
                <div class="col-12 col-md-6 align-h-center align-v-center">
                    ...
                    <div class="side-intro">
                        ...
                        <div class="description gray">
                            ...
                            <p>
                            <p class="white"><a href="https://orcasia.org/allfiles/ORCA's_GCNS_2024_Report.pdf" target="_blank"
                                    style="color:#e74646">Read ORCA's GCNS 2024 Conference Report</a></p>
    ...
    <section id="home" class="shock-section dynamic-slider scheme-1" data-autoplay="10000">
        ...
        <div class="slide-item side-intro">
            ...
            <div class="slide-content">
                ...
                <div class="slide-description">
                    <a href="https://orcasia.org/pages/india-china-trade-dashboard"> <span
                            class="text-2 text-style-7 text-italic white">India-China Trade Dashboard</span></a>
                    <div class="description gray">
                    ...
                    <div class="description gray line-clamp-3">
                        ...
                        <p>The dashboard is part of ORCA’s India-China Trade Project.
                            Synopsis: The India-China Trade dashboard- Annual is a comprehensive visualisation of yearly
                            merchandise trade between the two economies. It captures India’s imports and exports to China
                            between 2011-12 to 2021-22 based on the Harmonised System (HS Codes).</p>
                    </div>
                </div>
                <span class="slide-title text-1 text-style-1 black">&nbsp;</span>
            </div>
            ...
            <div class="slide-image-wrapper">
                <div class="slide-image-inner">
                    <img src="{{ URL::asset('images/jpg/dashboard1.png') }}" alt="Image name"
                        class="slide-image bg-color accent" />
                </div>
            </div>
            <!-- Action -->
            ...
            <div class="holder p-25 climb shadow rounded bg-color white">
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4">
                        ...
                        <div class="animated-counter">
                            <div class="item text-center">
                                <div class="counter text-style-5" data-value="900" data-symbol="+" data-duration="2500"
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        ...
                        <div class="animated-counter">
                            <div class="item text-center">
                                <div class="counter text-style-5" data-value="192" data-symbol="" data-duration="2500"
                                    data-text-bg-color="transparent" data-text-color="var(--primary-color)"></div>
                                    ...
                                    <div class="card-body align-v-bottom">
                                        <div class="holder">
                                            ...
                                            <span class="badge primary-50 primary-hover">
                                                <span
                                                    class="badge-text white white-hover">{{ $category->category }}</span>
                                            </span>
