                                            ...
                                            <div class="col-12 col-md-6 col-lg-6">
                                                <div class="megamenu-item has-side-image image-absolute-right">
                                                    <a href="{{ url('pages/team') }}" class="megamenu-image black">
                                                        <img src="{{ URL::asset('images/WhatsApp Image 2023-06-19 at 11.54.21 PM.jpeg') }}"
...
<a href="{{ url('login') }}" class="button small-button rounded primary-25 primary-hover hover-up-down">
    ...
    <footer id="footer" class="shock-footer scheme-1 primary">
        <div class="footer-content focus-trigger">
            <div class="container">
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="footer-item">
                            <a class='twitter-timeline' data-handle='ORCA_India' data-height='500'
                                data-theme='dark'></a>
        ...
        <div class="bottom-bar">
            <div class="text">ORCA © 2023 - All rights reserved. Designed by <a href="https://kwad.in"
                    class="link gray primary-hover"><u>Kwad</u></a>.</div>
        </div>
    </footer>
    <!-- Cursor -->
