...
<head>
    ...
    <link rel="icon" type="image/png" sizes="192x192"
        href="{{ URL::asset('images/favicon/android-icon-192x192.png') }}">
...
<body class="shock-body publicationbody">
    <!-- Header -->
    <header id="header" class="shock-header hidden-print">
        <!-- Navbar -->
                ...
                <div id="navbar-items" class="collapse navbar-collapse focus-trigger">
                    ...
                    <div class="search-bar navbar-collapse-form">
                        <div class="form-area d-only-mobile d-none scheme-1">
                            <form action="{{ url('search') }}" method="post" class="form-fields needs-validation"
                    ...
                    <ul class="navbar-nav ms-auto">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="megamenu-item pt-0">
                                                            <ul class="nav-list list-unstyled">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a href="{{ url('pages/authors') }}"
                                                                        class="nav-link parent">
                                                                        <span class="text">ORCA’s Community of
                                                                            Scholars</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a href="{{ url('pages/onv') }}"
                                                                        class="nav-link parent">
                                                                        <span class="text">Output & Ventures</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a href="{{ url('pages/submission') }}"
                                                                        class="nav-link parent">
                                                                        <span class="text">Submission
                                                                            Guidelines</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a href="{{ url('pages/partners') }}"
                                                                        class="nav-link parent">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-6">
                                                <div class="megamenu-item has-side-image image-absolute-right">
                                                    <a href="{{ url('pages/team') }}" class="megamenu-image black">
                                                        <img src="{{ URL::asset('images/teamorca.jpeg') }}"
                                ...
                                <div class="container">
                                    <div class="section-inner-expanded">
                                        <div class="row">
                                                            ...
                                                            <ul class="nav-list list-unstyled">
                                                                <li class="nav-item">
                                                                    <a href="{{ url('pages/publication') }}"
                                                                        class="nav-link parent">
                                                                        <span
                                                                            class="text"><strong>Overview</strong></span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a href="{{ url('category/cicm') }}"
                                                                        class="nav-link parent">
                                                                        <span class="text">Conversations In Chinese
                                                                            Media</span>
                                                                    </a>
                                                                </li>
                                                                <!--
                                                                <li class="nav-item">
                                                                    <a href="{{ url('category/cicm-insights') }}"
                                                                        class="nav-link parent">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a href="{{ url('category/reviewing-chinese-culture') }}"
                                                                        class="nav-link parent">
                                                                        <span class="text">Reviewing Chinese Culture
                                                                        </span>
                                                                    </a>
                                                                </li>

                                                                <li class="nav-item">
                                                                    <a href="{{ url('category/orca-in-hatha') }}"
                                                                        class="nav-link parent">
                                            ...
                                            <?php $latest_articles = App\Models\Article::select('id', 'author_id', 'category', 'read_time', 'title', 'slug', 'subtitle', 'title_image', 'created_at')
                                                ->whereIn('category', ['23'])
                                                            ...
                                                            <div class="card-body align-v-bottom">
                                                                <div class="holder">
                                                                    <a href="{{ url('category' . $category->slug) }}"
                                                                        class="link">
                                                                        <span
                                                                            class="badge outline primary primary-hover">
                                                                            <span
                                                                                class="badge-text white-75 white-hover">{{ $category->category }}</span>
                                                                        </span>
                                                                    </a>
                                                                    <h3 class="megamenuimg title text-style-9 white">
                                                                        {{ $article->title }}</h3>
                                                                    <a href="#your-link" class="link">
                                                                        <span
                                                                            class="mt-1 badge outline gray-50 secondary-hover">
                                                                            <span
                                                                                class="badge-text gray white-hover">{{ $author->name }}</span>
                                                                        </span>
                                                                    </a>
                                                                    <hr class="gray-25">
                                                                    <!-- Metadata -->
                                    ...
                                    <div class="section-inner-expanded">
                                        <div class="horizontal-tab scheme-1 primary">
                                            ...
                                            <ul id="elements-tab" class="nav nav-tabs js-tabs-event" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button id="elements-1-tab" class="title nav-link"
                                                        aria-selected="true" aria-controls="elements-1"
                                                        data-bs-target="#elements-6" data-bs-toggle="tab"
                                                        role="tab">
                                                        Special Reports
                                                    </button>
                                                </li>
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button id="elements-3-tab" class="title nav-link"
                                                        aria-selected="false" aria-controls="elements-3"
                                                        data-bs-target="#elements-3" data-bs-toggle="tab"
                                                        role="tab">
                                                        Central Committee
                                                    </button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button id="elements-4-tab" class="title nav-link"
                                                        aria-selected="false" aria-controls="elements-4"
                                                        data-bs-target="#elements-4" data-bs-toggle="tab"
                                                        role="tab">
                                                        Mapping China
                                                    </button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button id="elements-5-tab" class="title nav-link"
                                                        aria-selected="false" aria-controls="elements-5"
                                                        data-bs-target="#elements-5" data-bs-toggle="tab"
                                                        role="tab">
                                                        Infographics
                                                    </button>
                                                </li>
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button id="elements-7-tab" class="title nav-link"
                                                        aria-selected="false" aria-controls="elements-7"
                                                        data-bs-target="#elements-7" data-bs-toggle="tab"
                                                        role="tab">
                                                        Compendium
                                                    </button>
                                                </li>
                                            ...
                                            <div class="tab-content">
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="megamenu-item">
                                                                <ul class="nav-list list-unstyled">
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('article/722/indias-soft-push-for-power-in-south-asia') }}"
                                                                            class="nav-link parent">
                                                                            <span class="text">ORCA Special Issue
                                                                                2024</span>

                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('article/696/transboundary-water-security-in-south-asia') }}"
                                                                            class="nav-link parent">
                                                                            <span class="text">ORCA-NIICE Special
                                                                                Issue 2024</span>

                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('article/117/the-dalai-lamas-succession-strategic-realities-of-the-tibet-question') }}"
                                                                            class="nav-link parent">
                                                                            <span class="text">ORCA-ISDP Special
                                                                                Issue 2023</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('article/116/building-the-future-of-eu-india-strategic-partnership-between-trade-technology-security-and-china') }}"
                                                                            class="nav-link parent">
                                                                            <span class="text">ORCA-WICCI Special
                                                                                Issue 2023</span>
                                                        ...
                                                        <?php $latest_articles = App\Models\Article::select('id', 'author_id', 'category', 'read_time', 'title', 'slug', 'title_image', 'created_at')
                                                            ->whereIn('category', ['27'])
                                                            ->where('status', 'approved')
                                                            ->orderBy('created_at', 'desc')
                                                            ->limit(2)
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="card-body align-v-bottom">
                                                                            <div class="holder">
                                                                                ...
                                                                                <h3
                                                                                    class="megamenuimg title text-style-9 white">
                                                                                    {{ $article->title }}</h3>
                                                                                <hr class="gray-25">
                                                                                <!-- Metadata -->
                                                                                <div class="card-metadata">
                                                                ...
                                                                <ul class="nav-list list-unstyled">
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('pages/china-public-diplomacy-dashboard') }}"
                                                                            class="nav-link parent">
                                                                            <span class="text">CHINA’S PUBLIC
                                                                                DIPLOMACY DASHBOARD</span>
                                                                        </a>
                                                                        <div
                                                                            class="card has-full-image mt-05 vh-25 small-shadow rounded parent">
                                                                            <div class="bricklayer-column"
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="megamenu-item">
                                                                ...
                                                                <ul class="nav-list list-unstyled">
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('pages/19cc/part1') }}"
                                                                            class="nav-link parent">
                                                                            <span class="text">PART 1</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('pages/19cc/part2') }}"
                                                                            class="nav-link parent">
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="megamenu-item">
                                                                ...
                                                                <ul class="nav-list list-unstyled">
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('centralcommittee/20cc/the-prince-and-all-his-men-predicting-personnel-changes-in-the-20th-npc') }}"
                                                                            class="nav-link">
                                                                            <span class="text">Predictions</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('centralcommittee/20cc/implications-of-the-20th-party-congress-economics-politics-and-foreign-policy') }}"
                                                                            class="nav-link">
                                                                            <span
                                                                                class="text">Implications:China</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('pages/20cc/overview') }}"
                                                                            class="nav-link">
                                                                            <span class="text">Overview</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('centralcommittee/20cc/chinas-20th-party-congress-and-implications-for-india') }}"
                                                                            class="nav-link">
                                                                            <span
                                                                                class="text">Implications:India</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('centralcommittee/20cc/at-a-glance-20th-national-party-congress') }}"
                                                                            class="nav-link">
                                                ...
                                                <div id="elements-4" class="tab-pane fade" role="tabpanel">
                                                    ...
                                                    <a style="color:black; padding-left:1rem;"
                                                        href="https://orcasia.org/category/mapping-china">Explore
                                                        More</a>
                                                </div>
                                                                ...
                                                                <div class="card has-image shadow parent">
                                                                    ...
                                                                    <div class="card-body bg-color white">
                                                                        ...
                                                                        <span
                                                                            class="badge outline primary primary-hover">
                                                                            <span
                                                                                class="badge-text black-75 white-hover">{{ $category->category }}</span>
                                                                        </span>

                                                                        <h3 class="title mt-1 text-style-11 black">
                                                                            {{ $article->title }}</h3>
                                                                        <p class="description black line-clamp-3">
                                                                            {{ $article->subtitle }}</p>
                                                                        <!-- Button -->

                                                                    </div>
                                                                    <!-- Link -->
                                                                    <a href="{{ url('infographics/' . $article->slug) }}"
                                                                        class="full-link"></a>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="megamenu-item">
                                                                ...
                                                                <ul class="nav-list list-unstyled">
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('https://orcasia.org/allfiles/The-Prince-and-All-His-Men-Predicting-Personnel-Changes-in-the-20th-NPC_2022.pdf') }}"
                                                                            class="nav-link parent">
                                                                            <span class="text">ORCA Special Report
                                                                                1</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('https://orcasia.org/allfiles/GCNS_2023_Report.pdf') }}"
                                                                            class="nav-link parent">
                                                                            <span class="text">ORCA Special Report
                                                                                2</span>
                                                                        </a>
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('https://orcasia.org/allfiles/ORCA\'s_GCNS_2024_Report.pdf') }}"
                                                                            class="nav-link parent">
                                                                            <span class="text">ORCA Special Report
                                                                                3</span>
                                                                        </a>
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="card has-image shadow parent">
                                                                ...
                                                                <div class="image-wrapper imageheighter hover-zoom">
                                                                    <img src="{{ URL::asset('images/sprepo1.png') }}"
                                                                        alt="Image name" class="image" />
                                                                </div>
                                                        ...
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="card has-image shadow parent">
                                                                <!-- Image -->
                                                                <div class="image-wrapper imageheighter hover-zoom">
                                                                    <img src="{{ URL::asset('images/sperepo2.png') }}"
                                                                        alt="Image name" class="image" />
                                                                </div>
                                                ...
                                                <div id="elements-7" class="tab-pane fade" role="tabpanel">
                                                    <div class="row g-3">
                                                        <div class="col-12 col-md-6 col-lg-4">
                                                            <div class="megamenu-item">
                                                                <h6 class="title">Compendium</h6>
                                                                <ul class="nav-list list-unstyled">
                                                                    <li class="nav-item">
                                                                        <a href="{{ url('https://orcasia.org/episodesofexchanges') }}"
                                                                            class="nav-link parent">
                                                                            <span class="text">Episodes of
                                                                                India-China Exchanges: Modern Bridges
                                                                                and Resonant Connections</span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                        ...
                        <li class="nav-item has-megamenu hover">
                            <a class="nav-link dropdown-toggle has-icon" href="{{ url('pages/orcafiles') }}">
                                <span class="text"> <i style="color:black;"
                                        class="fa-solid fa-headphones icon"></i> The ORCA Files</span>
                            </a>
                        </li>
                        <li class="nav-item dropdown has-megamenu hover">
                            <a class="nav-link dropdown-toggle has-icon" href="#" data-bs-toggle="dropdown">
                                                            ...
                                                            <ul class="nav-list list-unstyled">
                                                                <li class="nav-item">
                                                                    <a href="https://orcasia.org/allfiles/ORCA's_GCNS_2024_Report.pdf"
                                                                        ...
                                                                        <span class="text">ORCA's GCNS 2024
                                                                            Conference Report</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a href="http://gcns.orcasia.org" target="_blank"
                                                                        class="nav-link parent">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a href="https://orcasia.org/allfiles/GCNS_2023_Report.pdf"
                                                                        target="_blank" class="nav-link parent">
                                                                        <span class="text">ORCA's GCNS 2023
                                                                            Conference Report</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a href="http://gcns2023.orcasia.org"
                                                                        target="_blank" class="nav-link parent">
                                                ...
                                                <div class="form-row row has-icon">
                                                    <div class="form-col form-floating">
                                                        ...
                                                        <input type="hidden" name="url"
                                                            value="{{ url('search/ajax') }}">
                                                        <input type="hidden" name="img_url"
                                                            value="{{ URL::asset('images/article') }}">
    ...
    <!-- Form -->
    <section class="shock-section has-overlay pt-5 pb-5 bg-image bg-fixed hidden-print"
        data-bg-image="{{ URL::asset('images/jpg/sub.jpeg') }}">
                ...
                <div class="col-12 col-md-6 align-h-center align-v-center">
                    ...
                    <div class="side-intro">
                        <h2 class="title white">
                            ...
                            <span class="text-2 text-style-6 text-italic">to our <mark
                                    class="animated-underline primary">newsletter</mark> !</span>
                        </h2>
                        <div class="description white">
                            <p class="white">Get a daily dose of local and national news from China, top trends in
                            ...
                            <div class="form-row row">
                                <div class="form-col col-12">
                                    <div class="form-check">
                                        <input type="checkbox" name="terms" id="InputCheckbox"
                                        ...
                                        <label class="form-label white form-check-label" for="InputCheckbox">
                                            I agree to the <a href="#your-link"
                                                class="link white primary-hover"><u>terms of use</u>.</a>
                                        </label>
    ...
    <footer id="footer" class="shock-footer scheme-1 primary">
        <div class="footer-content focus-trigger hidden-print">
            <div class="container">
                <div class="row g-3">
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        <div class="footer-item">
                            ...
                            <div class="list-wrapper">
                                <ul class="icon-h-list">
                                    ...
                                    <li class="item">
                                        <a href="https://twitter.com/ORCA_India"
                                            class="link gray primary-hover hover-rotate"><i
                                                class="icon fab fa-twitter"></i></a>
                                    </li>
                                    <li class="item">
                                        <a href="https://www.linkedin.com/company/orcasia/"
                                            class="link gray primary-hover hover-rotate"><i
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="footer-item">
                            ...
                            <ul class="nav-list list-unstyled">
                                @php
                                    $events = App\Models\Article::select('id', 'slug', 'title', 'created_at')->where('category', 31)->orderBy('created_at', 'desc')->limit(3)->get();
                                @endphp
                                @foreach($events as $event)
                                <li class="nav-item">
                                    <a href="{{ url('events/'.$event->slug)}}" class="nav-link">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            function handlePrintOrSave() {
                // Find all elements with the class 'hidden-print' and hide them
                document.querySelectorAll('.hidden-print').forEach(function(el) {
                    el.style.display = 'none'; // Hide the element
                });
                // Show the logo-print-only during print
                document.querySelector('.logo-print-only').style.display = 'block';
            }

            function handlePrintClose() {
                // Reset display for elements with the 'hidden-print' class after print
                document.querySelectorAll('.hidden-print').forEach(function(el) {
                    el.style.display = ''; // Show the element again
                });
                // Hide the logo-print-only after print
                document.querySelector('.logo-print-only').style.display = 'none';
            }

            // Listen for the print or save window opening
            window.onbeforeprint = handlePrintOrSave;
            window.onafterprint = handlePrintClose;
        });
    </script>
    <!-- Vendor JavaScript -->
