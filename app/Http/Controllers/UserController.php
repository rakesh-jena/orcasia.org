...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('yn-admin/users')->with('success', 'User created successfully.');
    }
    ...
    public function show($slug)
    {
        ...
        $a = Article::select('id', 'tags', 'title_image', 'views', 'author_id', 'title', 'created_at', 'category', 'slug')->where('status', 'approved')->where('author_id', 'LIKE', '%:"'.$user->id.'";%')->get();
        
        $episodes = DMArticle::select('id', 'tags', 'title_image', 'views', 'author_id', 'title', 'created_at', 'category', 'slug')->where('status', 'approved')->where('author_id', 'LIKE', '%:"'.$user->id.'";%')->get();
        $articles = [];
